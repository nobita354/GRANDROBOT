...
TECHNO_IMG = "https://telegra.ph/file/ed0f6094519ae66e5d648.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/MERA_NOBITA")],
                                                                                   [InlineKeyboardButton(text="ADD SUPER GROUP MANAGER BOT TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/MERA_NOBITA/GRANDROBOT")
                                                                                 ]]))
